      ...
      <main class="mdl-layout__content">
        ...
        <div class="learning-history-reflection">
          ...
          <div class="new-plan-create">
            <button class="new-plan-create-button mdl-button mdl-js-button mdl-button--raised">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M18 13h-5v5c0 .55-.45 1-1 1s-1-.45-1-1v-5H6c-.55 0-1-.45-1-1s.45-1 1-1h5V6c0-.55.45-1 1-1s1 .45 1 1v5h5c.55 0 1 .45 1 1s-.45 1-1 1z"/></svg>新規学習計画の作成
          </button>
