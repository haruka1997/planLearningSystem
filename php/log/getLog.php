<?php 
    ...
    try {
        ...
        $stmt = $dbh->prepare('SELECT history.userId, history.executing, history.achievement, history.satisfaction, history.goal, history.testScore, history.settingId, history.recordTime, history.comment FROM history WHERE history.coverage = :coverage AND history.subjects = "2020年基礎数学C" ORDER BY history.userId'); 
