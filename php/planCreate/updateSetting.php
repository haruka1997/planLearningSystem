<?php 
    ...
    try {
        ...
        $stmt = $dbh->prepare('UPDATE history SET coverage = :coverage, prepareDate = :prepareDate, understanding = :understanding, goal = :goal, satisfaction = :satisfaction, testScore = :testScore, achievement = :achievement, executing = :executing WHERE settingId = :settingId'); 
