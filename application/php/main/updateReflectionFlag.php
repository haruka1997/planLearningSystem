<?php 
    ...
    try {
        ...
        $stmt = $dbh->prepare('UPDATE history SET reflectionFlag = :reflectionFlag WHERE settingId = :settingId'); 

        $stmt->bindParam(':reflectionFlag', $_POST['reflectionFlag'], PDO::PARAM_STR);
